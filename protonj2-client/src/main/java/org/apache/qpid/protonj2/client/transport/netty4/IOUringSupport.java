...
public final class IOUringSupport {
    ...
    static {
        ...
        try {
            ...
            ioHandlerFactory = ioUringHandler.getDeclaredMethod("newFactory", (Class<?>[])null);
            socketChannelClass = (Class<? extends Channel>) Class.forName("io.netty.channel.uring.IoUringSocketChannel");
            available = (boolean) isAvailable.invoke(null, (Object[])null);
        } catch (Exception e) {
    ...
    public static EventLoopGroup createGroup(int nThreads, ThreadFactory ioThreadFactory) {
        ...
        if (INCUBATOR_VARIANT) {
            ...
            try {
                return (EventLoopGroup) EVENTLOOP_CONSTRUCTOR.newInstance(nThreads, ioThreadFactory, IOHANDLER_FACTORY.invoke(null, null, (Object[])null));
            } catch (Exception e) {
