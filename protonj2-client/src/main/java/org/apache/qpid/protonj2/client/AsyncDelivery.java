...
/**
 * Incoming asynchronously dispatched AsyncDelivery type that provides access to the message
 * and the delivery data along with methods for settling the delivery when processing
 * completes.
 */
public interface AsyncDelivery {

    /**
     * @return the {@link Listener} that originated this {@link AsyncDelivery}.
     */
    Listener listener();

    /**
     * Decode the {@link AsyncDelivery} payload and return an {@link Message} object.
     * <p>
     ...
     * excludes use of the {@link #rawInputStream()} method of the {@link AsyncDelivery} object.  Calling
    ...
    /**
     * Create and return an {@link InputStream} that reads the raw payload bytes of the given {@link AsyncDelivery}.
     * <p>
     * Calling this method claims the payload of the delivery for the returned {@link InputStream} and excludes
     * use of the {@link #message()} and {@link #annotations()} methods of the {@link AsyncDelivery} object.  Closing
    ...
    /**
     * Decodes the {@link AsyncDelivery} payload and returns a {@link Map} containing a copy
     * of any associated {@link DeliveryAnnotations} that were transmitted with the {@link Message}
     * payload of this {@link AsyncDelivery}.
     * <p>
     ...
     * {@link #rawInputStream()} method of the {@link AsyncDelivery} object.  Calling the {@link #rawInputStream()}
     ...
     *
     * @return this {@link AsyncDelivery} instance.
     *
     * @throws ClientException if an error occurs while sending the disposition
     */
    AsyncDelivery accept() throws ClientException;
     ...
     * @throws ClientException if an error occurs while sending the disposition
     */
    AsyncDelivery release() throws ClientException;
     ...
     * @throws ClientException if an error occurs while sending the disposition
     */
    AsyncDelivery reject(String condition, String description) throws ClientException;
     ...
     * @throws ClientException if an error occurs while sending the disposition
     */
    AsyncDelivery modified(boolean deliveryFailed, boolean undeliverableHere) throws ClientException;
     ...
     * @throws ClientException if an error occurs while sending the disposition
     */
    AsyncDelivery disposition(DeliveryState state, boolean settle) throws ClientException;
     ...
     * @throws ClientException if an error occurs while sending the disposition
     */
    AsyncDelivery settle() throws ClientException;
