...
/**
 * An delivery object that tracks an incoming delivery that was dispatched to
 * a listener target asynchronously.
 */
public class ClientAsyncDelivery extends ClientDeliverable<ClientAsyncDelivery, ClientListener> implements AsyncDelivery {
    ...
    ClientAsyncDelivery(ClientListener receiver, IncomingDelivery delivery) {
    ...
    @Override
    protected ClientAsyncDelivery self() {
        return this;
    }
